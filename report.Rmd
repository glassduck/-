...
__가장 높은 rent 수요를 보인 장르는 Sport이고 이때의 총 판매량은 4892.19이다.__

__반면 가장 낮은 rent 수요를 보인 장르는 Music 이고 이때의 total_sales는 3071.52이다.__

__추가적으로, rent demand와 sales는 양의 상관관계를 가지고 있음을 시각적으로 확인할 수 있었고 회귀분석 결과, demand가 한단위 증가할 수록 sales는 3.48가량 늘어났으며 이때의 R스퀘어는 0.69였다. 정확성이 높지는 않으나 선형성이 있음을 충분히 의심해 볼 만하다__
...
```
__가장 높은 1인당 매출을 기록한  손님은 Eleanor Hunt라는 고객이며 Runion이란 국가 출신이며 그 사람의 1인당 매출은 211.55이다.__
